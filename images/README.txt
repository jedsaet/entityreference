...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <head>
    <title>
      README.txt dans webfactory/trunk/sites/all/modules/custom/entity_reference_tree/images.
    ...
    <!--[if IE]><script type="text/javascript">window.location.hash = window.location.hash;</script><![endif]-->
        ...
        <link rel="alternate" href="/hug/intranet-tma/trac/browser/webfactory/trunk/sites/all/modules/custom/entity_reference_tree/images/README.txt?format=txt" type="text/plain" title="Texte brut" /><link rel="alternate" href="/hug/intranet-tma/trac/export/2519/webfactory/trunk/sites/all/modules/custom/entity_reference_tree/images/README.txt" type="text/plain; charset=utf-8" title="Format original" />
        ...
        <link rel="prev" href="/hug/intranet-tma/trac/browser/webfactory/trunk/sites/all/modules/custom/entity_reference_tree/images/README.txt?rev=1074" title="Révision 1074" />
    ...
    <div id="main">
      <div id="ctxtnav" class="nav">
        <h2>Navigation contextuelle</h2>
          <ul>
              <li class="first"><span>&larr; <a class="prev" href="/hug/intranet-tma/trac/browser/webfactory/trunk/sites/all/modules/custom/entity_reference_tree/images/README.txt?rev=1074" title="Révision 1074">Révision précédente</a></span></li><li><span class="missing">Révision suivante &rarr;</span></li><li><a href="/hug/intranet-tma/trac/browser/webfactory/trunk/sites/all/modules/custom/entity_reference_tree/images/README.txt?annotate=blame" title="Annoter chaque ligne avec la révision de la dernière modification (ce procédé peut-être coûteux en temps...)">Annoter</a></li><li class="last"><a href="/hug/intranet-tma/trac/log/webfactory/trunk/sites/all/modules/custom/entity_reference_tree/images/README.txt">Journal des révisions</a></li>
          </ul>
        <hr />
      </div>
...
<br style="clear: both" />
      ...
      <table id="info" summary="Info révision">
        <tr>
          <th scope="col">Révision <a href="/hug/intranet-tma/trac/changeset/2161">2161</a>,
            <span title="223 octets">223 octets</span>
            produite par fredrik.lahode, il y a <a class="timeline" href="/hug/intranet-tma/trac/timeline?from=2014-01-14T17%3A04%3A32%2B01%3A00&amp;precision=second" title="2014-01-14T17:04:32+01:00 dans « Activité »">4 mois</a>
            (<a href="/hug/intranet-tma/trac/changeset/2161/webfactory/trunk/sites/all/modules/custom/entity_reference_tree/images/README.txt">différences</a>)</th>
        </tr>
        <tr>
  ...
  <table class="code"><thead><tr><th class="lineno" title="Numéros de lignes">Ligne</th><th class="content"> </th></tr></thead><tbody><tr><th id="L1"><a href="#L1">1</a></th><td>The icons contained in this directory are from the FatCow "Farm-Fresh Web Icons" </td></tr><tr><th id="L2"><a href="#L2">2</a></th><td>collection, available under the Creative Commons Attribution 3.0 license.  They</td></tr><tr><th id="L3"><a href="#L3">3</a></th><td>can be downloaded here:</td></tr><tr><th id="L4"><a href="#L4">4</a></th><td></td></tr><tr><th id="L5"><a href="#L5">5</a></th><td>http://www.fatcow.com/free-icons</td></tr></tbody></table>
      ...
      <div id="anydiff">
        <form action="/hug/intranet-tma/trac/diff" method="get">
          <div class="buttons">
            <input type="hidden" name="new_path" value="/webfactory/trunk/sites/all/modules/custom/entity_reference_tree/images/README.txt" />
            <input type="hidden" name="old_path" value="/webfactory/trunk/sites/all/modules/custom/entity_reference_tree/images/README.txt" />
    ...
    <div id="altlinks">
      ...
      <ul>
        <li class="first">
          <a rel="nofollow" href="/hug/intranet-tma/trac/browser/webfactory/trunk/sites/all/modules/custom/entity_reference_tree/images/README.txt?format=txt">Texte brut</a>
        </li><li class="last">
          <a rel="nofollow" href="/hug/intranet-tma/trac/export/2519/webfactory/trunk/sites/all/modules/custom/entity_reference_tree/images/README.txt">Format original</a>
        </li>
      </ul>
    </div>
    </div>
